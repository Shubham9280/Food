...
ROOT_DIR = os.path.abspath("C:\FOOD")
...
class foodDataset(utils.Dataset):
    ...
    def load_food(self, dataset_dir, subset):
        ...
        self.add_class("colour", 1, "red")
        self.add_class("colour", 2, "white")
        self.add_class("colour", 3, "yellow")
        self.add_class("colour", 4, "pink")
        self.add_class("colour", 5, "green")
        self.add_class("taste", 1, "spicy")
        self.add_class("taste", 2, "lemony")
        self.add_class("taste", 3, "sweet")
